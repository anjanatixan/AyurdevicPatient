          ...
          child: ListView(
            ...
            children: [
              ...
              Consumer<PatientProvider>(builder: (context, provider, child) {
                return provider.patientListModel != null &&provider.patientListModel!.patient.isNotEmpty
                    ? ListView.builder(
                        itemCount: provider.patientListModel!.patient.length,
                        shrinkWrap: true,
                    ...
                    : Container(
                      ...
                      child: Center(
                          child: Text("No patient are register now"),
                        ),
                    );
              })
            ],
